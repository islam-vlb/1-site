...
export const PRODUCTS: Product[] = [
  {
    ...
    variants: [
      { id: "1kit-none", label: "1 Basal Body Thermometer", price: 47.89, image: "/images/products/1kit-open-contents.jpg", meta: "No supplement included", group: "kit-only" },
      { id: "1kit-30", label: "1 Thermometer + 1 Bottle — 30 Capsules", price: 49.76, image: "/images/products/1kit-30ct-bundle.jpg", group: "bundles", bundle: true, bottleCount: 1, capsuleCount: 30 },
      { id: "1kit-60", label: "1 Thermometer + 1 Bottle — 60 Capsules", price: 53.45, image: "/images/products/1kit-60ct-bundle.jpg", group: "bundles", bundle: true, bottleCount: 1, capsuleCount: 60 },
      { id: "1kit-90", label: "1 Thermometer + 1 Bottle — 90 Capsules", price: 54.95, image: "/images/products/1kit-90ct-bundle.jpg", group: "bundles", bundle: true, bottleCount: 1, capsuleCount: 90 },
      { id: "2kit-none", label: "2 Thermometers", price: 86.88, image: "/images/products/2kit-open-contents.jpg", meta: "No supplement included", group: "kit-only" },
      { id: "2kit-30", label: "2 Thermometers + 1 Bottle — 30 Capsules", price: 87.64, image: "/images/products/2kit-30ct-bundle.jpg", group: "bundles", bundle: true, bottleCount: 1, capsuleCount: 30 },
      { id: "2kit-60", label: "2 Thermometers + 1 Bottle — 60 Capsules", price: 87.76, image: "/images/products/2kit-60ct-bundle.jpg", group: "bundles", bundle: true, bottleCount: 1, capsuleCount: 60 },
      { id: "2kit-90", label: "2 Thermometers + 1 Bottle — 90 Capsules", price: 94.82, image: "/images/products/2kit-90ct-bundle.jpg", group: "bundles", bundle: true, bottleCount: 1, capsuleCount: 90 },
      { id: "3kit-none", label: "3 Thermometers", price: 96.95, image: "/images/products/3kit-boxes.jpg", meta: "No supplement included", group: "kit-only" },
    ],
    image: {

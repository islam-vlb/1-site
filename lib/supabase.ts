...
export const PRODUCTS: Product[] = [
  {
    ...
    variants: [
      { id: "1kit-none", label: "1 Basal Body Thermometer", price: 47.89, image: "/images/products/nuressa/nuressa-thermo-1.png", group: "single" },
      { id: "1kit-30", label: "1 Basal Body Thermometer + Fertility Tracking Journal", price: 49.76, image: "/images/products/nuressa/nuressa-thermo-1-plus-1journal.png", group: "single", meta: "Includes 1 Fertility Tracking Journal", bundle: true },
      { id: "1kit-60", label: "1 Basal Body Thermometer + 2 Fertility Tracking Journals", price: 53.45, image: "/images/products/nuressa/nuressa-thermo-1-plus-2journal.png", group: "single", meta: "Includes 2 Fertility Tracking Journals", bundle: true },
      { id: "1kit-90", label: "1 Basal Body Thermometer + 3 Fertility Tracking Journals — Complete Kit", price: 54.95, image: "/images/products/nuressa/nuressa-thermo-1-plus-3journal.png", group: "single", meta: "Includes 3 Fertility Tracking Journals — best value", bundle: true },
      { id: "2kit-none", label: "2 Thermometers", price: 86.88, image: "/images/products/nuressa/nuressa-thermo-2.png", group: "double" },
      { id: "2kit-30", label: "2 Thermometers + Fertility Tracking Journal", price: 87.64, image: "/images/products/nuressa/nuressa-thermo-2-plus-1journal.png", group: "double", meta: "Includes 1 Fertility Tracking Journal", bundle: true },
      { id: "2kit-60", label: "2 Thermometers + 2 Fertility Tracking Journals", price: 87.76, image: "/images/products/nuressa/nuressa-thermo-2-plus-2journal.png", group: "double", meta: "Includes 2 Fertility Tracking Journals", bundle: true },
      { id: "2kit-90", label: "2 Thermometers + 3 Fertility Tracking Journals — Complete Kit", price: 94.82, image: "/images/products/nuressa/nuressa-thermo-2-plus-3journal.png", group: "double", meta: "Includes 3 Fertility Tracking Journals — best value", bundle: true },
      { id: "3kit-none", label: "3 Thermometers", price: 96.95, image: "/images/products/nuressa/nuressa-thermo-3.png", group: "triple" },
    ],
    image: {
      src: "/images/products/nuressa/nuressa-thermo-1.png",
  ...
  },
  {
    ...
    variants: [
      { id: "1x30", label: "1 Charting Journal — Standard", price: 9.99, image: "/images/products/nuressa/nuressa-journal-1-standard.png" },
      { id: "1x60", label: "1 Charting Journal — Plus", price: 13.95, image: "/images/products/nuressa/nuressa-journal-1-plus.png" },
      { id: "1x90", label: "1 Charting Journal — Premium", price: 14.75, image: "/images/products/nuressa/nuressa-journal-1-premium.png" },
      { id: "1x120", label: "1 Charting Journal — Complete", price: 17.95, image: "/images/products/nuressa/nuressa-journal-1-complete.png" },
      { id: "2x60", label: "2 Charting Journals", price: 18.75, image: "/images/products/nuressa/nuressa-journal-2.png" },
      { id: "3x60", label: "3 Charting Journals", price: 28.76, image: "/images/products/nuressa/nuressa-journal-3.png" },
      { id: "4x60", label: "4 Charting Journals", price: 38.64, image: "/images/products/nuressa/nuressa-journal-4.png" },
    ],
    image: {
      src: "/images/products/nuressa/nuressa-journal-1-plus.png",
